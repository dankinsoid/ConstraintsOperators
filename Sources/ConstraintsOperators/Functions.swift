...
extension LayoutAttribute {
	...
	public subscript<K: ConstraintsCreator>(_ rhs: LayoutAttribute<A, K>) -> ConstraintWrapper<C> where C.Second == K.First, K.A == NSLayoutConstraint.Attribute {
		equal(to: rhs)
	}
	...
	public subscript(_ rhs: CGFloat) -> ConstraintWrapper<C> {
		equal(to: rhs)
	}
...
extension LayoutAttribute where C.Second == UILayoutable {
	...
	public subscript(_ rhs: C.Second) -> ConstraintWrapper<C> {
		equal(to: rhs)
	}
...
extension LayoutAttribute where A == Attributes.CenterX {
	...
	public subscript<K: ConstraintsCreator>(to rhs: LayoutAttribute<A, K>) -> ConstraintWrapper<C> where C.Second == K.First, K.A == NSLayoutConstraint.Attribute {
		equal(to: rhs)
	}
	...
	public subscript<T: CenterXAttributeCompatible, K: ConstraintsCreator>(to rhs: LayoutAttribute<T, K>?) -> ConstraintWrapper<C>? where C.Second == K.First, K.A == NSLayoutConstraint.Attribute {
		equal(to: rhs)
	}
